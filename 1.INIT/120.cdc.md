...
Il faut que l’application fonctionne sur tous les types de téléphones (Android, Apple…). 
Une version s’adaptant aux tablettes doit aussi être mise en place.
...
- La fréquentation de l’application diminuera fortement pendant les grandes vacances.
